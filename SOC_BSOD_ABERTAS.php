...
<html>
<head>
<meta HTTP-EQUIV = "Refresh" CONTENT = "30; URL = SOC_INT_ABERTAS.php">
<style type="text/css"> 
body {
	...
	background-image: url(imagens/TelaoSOC_BSOD2.png);
...
// SQL query - BSOD
$sql = 'SELECT * FROM recs_abertas where DESC_UD  = "SOC BSOD"'; 

// SQL query - SOC BSOD
$sq2 = 'SELECT * FROM rec_online_histograma_final where DESC_UD  = "SOC BSOD"'; 
