...
<html>
<head>
<meta HTTP-EQUIV = "Refresh" CONTENT = "30; URL = SOC_BSOD_ABERTAS.php">
<style type="text/css"> 
body {
	...
	background-image: url(imagens/TelaoSOC_BHE2.png);
...
// SQL query - BHE
$sql = 'SELECT * FROM recs_abertas where DESC_UD  = "SOC BHE"'; 

// SQL query - SOC BHE
$sq2 = 'SELECT * FROM rec_online_histograma_final where DESC_UD  = "SOC BHE"';
