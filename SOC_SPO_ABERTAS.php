...
<meta HTTP-EQUIV = "Refresh" CONTENT = "30; URL = SOC_BHE_ABERTAS.php">
<style type="text/css"> 
body {
	...
	background-image: url(imagens/TelaoSOC_SPO2.png);
...
// SQL query - SOC SPO
$sql = 'SELECT * FROM recs_abertas where DESC_UD  = "SOC SPO"'; 

// SQL query - SOC SPO
$sq2 = 'SELECT * FROM rec_online_histograma_final where DESC_UD  = "SOC SPO"'; 
